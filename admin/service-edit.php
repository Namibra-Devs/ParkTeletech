...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		if($path != '' && $path1 == '') {
			unlink('../assets/uploads/service/'.$_POST['current_photo']);

			$final_name = 'service-'.$_REQUEST['id'].'.'.$ext;
        	move_uploaded_file( $path_tmp, '../assets/uploads/service/'.$final_name );
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<img src="../assets/uploads/service/<?php echo $photo; ?>" alt="Service Photo" style="width:400px;">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<img src="../assets/uploads/service/<?php echo $banner; ?>" alt="Service Banner Photo" style="width:400px;">
							</div>
						</div>
						<div class="form-group">
