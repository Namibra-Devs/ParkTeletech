...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_team_member (name,slug,designation_id,photo,degree,detail,facebook,twitter,linkedin,youtube,google_plus,instagram,flickr,address,practice_location,phone,email,website,status,meta_title,meta_keyword,meta_description) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
